...
#   ./gen.py tag 2.19.0rc5
let
  lib = import ../lib.nix;

  version = "2.19.0rc5";
  hash = "sha256-rPfG9dnU7t5Vgkpyxdm+Le1Ec6wScQY6yUsAQtVEv/4=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc5/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc5/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
