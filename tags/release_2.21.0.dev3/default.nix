...
#   python -m gen tag 2.21.0.dev3
let
  lib = import ../../common/lib.nix;

  version = "2.21.0.dev3";
  hash = "sha256-xvahQQFL4kzC81VMgY7jfFtpTmN1BuZAcVtmNjlCuto=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev3/src/rust/engine/rust-toolchain
  rustVersion = "1.76.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
