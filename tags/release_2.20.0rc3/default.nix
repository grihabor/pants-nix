...
#   python -m gen tag 2.20.0rc3
let
  lib = import ../../common/lib.nix;

  version = "2.20.0rc3";
  hash = "sha256-+kWJ82n4+5dncMpJFtyXKJhAVAcrXyP1OP1xxkyP2LQ=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc3/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
