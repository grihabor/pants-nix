...
#   python -m gen tag 2.19.1
let
  lib = import ../../common/lib.nix;

  version = "2.19.1";
  hash = "sha256-qj0ghH61wjeCBijBopgu5sA7jeEuakNTaMj9ccXFsr4=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.1/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
