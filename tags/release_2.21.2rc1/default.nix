...
#   python -m gen tag 2.21.2rc1
let
  lib = import ../../common/lib.nix;

  version = "2.21.2rc1";
  hash = "sha256-Mf+TBmKelZFKJnJmdRp5JBQRkmZ6HRWy5DSd256AvCA=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.2rc1/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.2rc1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
