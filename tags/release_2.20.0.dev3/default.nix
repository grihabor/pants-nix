...
#   python -m gen tag 2.20.0.dev3
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev3";
  hash = "sha256-JmqQPtoGIxpfPX8DQ/OFJnsITqVN1gAYcn6/kwDYDy0=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev3/src/rust/engine/rust-toolchain
  rustVersion = "1.74.1";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
