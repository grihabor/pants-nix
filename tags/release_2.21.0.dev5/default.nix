...
#   python -m gen tag 2.21.0.dev5
let
  lib = import ../../common/lib.nix;

  version = "2.21.0.dev5";
  hash = "sha256-cIpXzeH/uwDf9i1crhV/rjRKdDvVJpt9/pD8Xai0Abc=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev5/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev5/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
