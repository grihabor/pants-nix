...
#   python -m gen tag 2.22.0a0
let
  lib = import ../../common/lib.nix;

  version = "2.22.0a0";
  hash = "sha256-UzYHdYjXyX8BU8JrA1LEq7fFya1S5U7v9fhUz7UL4rs=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0a0/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0a0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
