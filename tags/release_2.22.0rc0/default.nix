...
#   python -m gen tag 2.22.0rc0
let
  lib = import ../../common/lib.nix;

  version = "2.22.0rc0";
  hash = "sha256-zcDmUcQCR94nPdJ/vTEQqaw2MqqmX6VfH9TQ1zXbDSE=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
