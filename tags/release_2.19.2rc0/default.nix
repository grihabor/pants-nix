...
#   python -m gen tag 2.19.2rc0
let
  lib = import ../../common/lib.nix;

  version = "2.19.2rc0";
  hash = "sha256-VL7YoIP7PGO+sXJJ3Mmly1my2OzGXmUv9LZr/AjGnJE=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.2rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.2rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
