...
let
  ...
  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
