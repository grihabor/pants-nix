...
#   python -m gen tag 2.20.3rc1
let
  lib = import ../../common/lib.nix;

  version = "2.20.3rc1";
  hash = "sha256-0eDH5c8uQfxOHJvpbkwW3+0tfjhfmHKo8zVxp98nbis=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.3rc1/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.3rc1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
