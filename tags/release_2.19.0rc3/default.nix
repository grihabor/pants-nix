...
#   ./gen.py tag 2.19.0rc3
let
  lib = import ../lib.nix;

  version = "2.19.0rc3";
  hash = "sha256-RYtUdeIN8GFuLId7v1ZIst5OE9EkVI08Y7lkBvD7OCI=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc3/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
