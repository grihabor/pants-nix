...
#   python -m gen tag 2.23.0a0
let
  lib = import ../../common/lib.nix;

  version = "2.23.0a0";
  hash = "sha256-lIZZZ7Olhd244nVZVV/4mfAAV6+DINafMhTx16agb0I=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0a0/src/rust/engine/rust-toolchain
  rustVersion = "1.81.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0a0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
