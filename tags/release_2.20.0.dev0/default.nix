...
#   python -m gen tag 2.20.0.dev0
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev0";
  hash = "sha256-6/nxBkwaA7AknhfU/tamonaZe0WL/BNzASFznuqNK9Q=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev0/src/rust/engine/rust-toolchain
  rustVersion = "1.74.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
