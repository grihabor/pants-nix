...
#   python -m gen tag 2.21.0.dev4
let
  lib = import ../../common/lib.nix;

  version = "2.21.0.dev4";
  hash = "sha256-QuQ31PbEKLG+AzNz02XcI5Y0k2o2EswT2JrrC7mLx2A=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev4/src/rust/engine/rust-toolchain
  rustVersion = "1.76.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev4/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
