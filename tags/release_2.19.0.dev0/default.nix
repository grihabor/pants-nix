...
#   ./gen.py tag 2.19.0.dev0
let
  lib = import ../lib.nix;

  version = "2.19.0.dev0";
  hash = "sha256-ZmOpi6381QNvAgqnk5DNQipuFsz41dy0L7YmiBmJwXU=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev0/src/rust/engine/rust-toolchain
  rustVersion = "1.72.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
