...
#   ./gen.py tag 2.19.0rc1
let
  lib = import ../lib.nix;

  version = "2.19.0rc1";
  hash = "sha256-x8z5CFcv5m0QcjDf96HpQD9jKzLrjJaOreXGg88pUEw=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc1/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
