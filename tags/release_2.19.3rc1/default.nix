...
#   python -m gen tag 2.19.3rc1
let
  lib = import ../../common/lib.nix;

  version = "2.19.3rc1";
  hash = "sha256-/c6FqRS/Qh+MBRmZupPCJA1O8u8bW8MSVqeeJLvpfaA=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.3rc1/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.3rc1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
