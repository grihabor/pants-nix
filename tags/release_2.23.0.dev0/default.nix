...
#   python -m gen tag 2.23.0.dev0
let
  lib = import ../../common/lib.nix;

  version = "2.23.0.dev0";
  hash = "sha256-PM2Xv1pp6bH/g3KRAwD61JC0zYCAtSH0VBAbzfo94OI=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev0/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
