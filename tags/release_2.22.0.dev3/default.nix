...
#   python -m gen tag 2.22.0.dev3
let
  lib = import ../../common/lib.nix;

  version = "2.22.0.dev3";
  hash = "sha256-BBPZ7zOTM2iY0e9DhU8XGq0mx70ud61wbt/mtDcDBwI=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0.dev3/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0.dev3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
