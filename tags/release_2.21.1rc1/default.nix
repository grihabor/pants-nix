...
#   python -m gen tag 2.21.1rc1
let
  lib = import ../../common/lib.nix;

  version = "2.21.1rc1";
  hash = "sha256-cwgWvbo+MrUoFbWTEkQP7dvshEbmBD4QLzenoFtLEts=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.1rc1/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.1rc1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
