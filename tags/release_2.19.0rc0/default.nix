...
#   ./gen.py tag 2.19.0rc0
let
  lib = import ../lib.nix;

  version = "2.19.0rc0";
  hash = "sha256-W0YA2znxwT+VF9Rry9TNqcei3JhOHR+zxtg/LNuYH40=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
