...
#   ./gen.py tag 2.19.0.dev4
let
  lib = import ../lib.nix;

  version = "2.19.0.dev4";
  hash = "sha256-gcXcxFWChezifnoZO3y+GuYiaVOi39S6BEZ16Or9zU8=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev4/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev4/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
