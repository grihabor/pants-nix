...
#   python -m gen tag 2.19.3
let
  lib = import ../../common/lib.nix;

  version = "2.19.3";
  hash = "sha256-hr2LSJdadoydx/binyFOFNUCoJq8XxmCBFg1/ZpKVMs=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.3/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
