...
#   python -m gen tag 2.22.0.dev0
let
  lib = import ../../common/lib.nix;

  version = "2.22.0.dev0";
  hash = "sha256-EtQYwrSex9LlY05ctsaz2jZIP9L5FKDxrHcKVRCPS5U=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0.dev0/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0.dev0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
