let
  ...
  version = "2.21.0a0";
  hash = "sha256-uCEZ0sPjy8Xc1yoKtyNn0zwqb7uoY8yo/RiyJe4xjv0=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0a0/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # curl -L -o Cargo.lock https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0a0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
