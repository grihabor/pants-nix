...
#   python -m gen tag 2.20.1rc0
let
  lib = import ../../common/lib.nix;

  version = "2.20.1rc0";
  hash = "sha256-yZDN/k2qAOhSdeWbdTSGPQxU54FTV00oINNhOQAVp4c=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.1rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.1rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
