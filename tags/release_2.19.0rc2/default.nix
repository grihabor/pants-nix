...
#   ./gen.py tag 2.19.0rc2
let
  lib = import ../lib.nix;

  version = "2.19.0rc2";
  hash = "sha256-f0PlnftsANlSAhwUT+2r9NQLZwkpMNeNhBFTeFlXxPE=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc2/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc2/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
