...
#   python -m gen tag 2.22.0.dev2
let
  lib = import ../../common/lib.nix;

  version = "2.22.0.dev2";
  hash = "sha256-8RApDhe4ocmgDa4zBVPpZVt9fe+DXJO7Kwz7QxtIFds=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0.dev2/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.0.dev2/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
