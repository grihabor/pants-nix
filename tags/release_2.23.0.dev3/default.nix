...
#   python -m gen tag 2.23.0.dev3
let
  lib = import ../../common/lib.nix;

  version = "2.23.0.dev3";
  hash = "sha256-JC4uQ4AXUH30JgxE/Xc22SP7KTLShdHAByht6k/tgkg=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev3/src/rust/engine/rust-toolchain
  rustVersion = "1.79.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
