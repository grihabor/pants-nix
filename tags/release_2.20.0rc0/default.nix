...
#   python -m gen tag 2.20.0rc0
let
  lib = import ../../common/lib.nix;

  version = "2.20.0rc0";
  hash = "sha256-TQGr5Kw9aWbKpG4wxXPdh3kittoPZVFYM/pndKTYO3w=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
