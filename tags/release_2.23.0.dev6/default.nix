...
#   python -m gen tag 2.23.0.dev6
let
  lib = import ../../common/lib.nix;

  version = "2.23.0.dev6";
  hash = "sha256-QXm/SxaMKXm6iJaBFMsxBBbYHvDeVg9rj4EkDmAyp3o=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev6/src/rust/engine/rust-toolchain
  rustVersion = "1.80.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev6/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
