...
#   python -m gen tag 2.21.2rc0
let
  lib = import ../../common/lib.nix;

  version = "2.21.2rc0";
  hash = "sha256-46LpTNSutf46C9S7vvdfFtRIuYrv5HeKX0ZzADF2Cig=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.2rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.2rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
