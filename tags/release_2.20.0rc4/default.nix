...
#   python -m gen tag 2.20.0rc4
let
  lib = import ../../common/lib.nix;

  version = "2.20.0rc4";
  hash = "sha256-+wTF3qzLuSDlZuLhiZ5YsD9R41IUmuM6/yrB+x7vYbQ=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc4/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc4/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
