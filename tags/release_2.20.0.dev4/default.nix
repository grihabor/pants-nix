...
#   python -m gen tag 2.20.0.dev4
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev4";
  hash = "sha256-Yxgp5Rf+3w/+Vy1u9DCL3LL+ShRx8cOoN5DgpsW4Mu0=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev4/src/rust/engine/rust-toolchain
  rustVersion = "1.74.1";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev4/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
