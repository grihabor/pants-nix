...
#   python -m gen tag 2.19.3rc0
let
  lib = import ../../common/lib.nix;

  version = "2.19.3rc0";
  hash = "sha256-QwFmn5Tdo//ID7VS2Ufv1A3iO5C6QA6zJMDW7wS+S/w=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.3rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.3rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
