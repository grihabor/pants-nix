...
#   python -m gen tag 2.20.0.dev7
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev7";
  hash = "sha256-9kvkRxJqG0IpbV5rcbawa1icVROmbYACyVUyve6l0ss=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev7/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev7/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
