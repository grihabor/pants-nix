...
#   python -m gen tag 2.21.1
let
  lib = import ../../common/lib.nix;

  version = "2.21.1";
  hash = "sha256-JgtvoQt5B7mUCfI7q5nzoJ8Rf584RbgSJ3hOoxlhakk=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.1/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
