...
#   python -m gen tag 2.19.1rc1
let
  lib = import ../../common/lib.nix;

  version = "2.19.1rc1";
  hash = "sha256-GA0CnUx7peW+/64UDK87v/4VJ36YsNWcBww6uVv5FkU=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.1rc1/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.1rc1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
