...
#   python -m gen tag 2.19.1rc0
let
  lib = import ../../common/lib.nix;

  version = "2.19.1rc0";
  hash = "sha256-XXojXo1MMEGz9AfLGN/tX3xyvFEZLlsx0b397ZDxIfs=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.1rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.1rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
