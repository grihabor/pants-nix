...
#   python -m gen tag 2.21.0
let
  lib = import ../../common/lib.nix;

  version = "2.21.0";
  hash = "sha256-IsOg5OyXWHZoHPFh2cg5stgbUytxhflf1iurrXjL2fw=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
