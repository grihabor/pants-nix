...
#   python -m gen tag 2.20.0rc2
let
  lib = import ../../common/lib.nix;

  version = "2.20.0rc2";
  hash = "sha256-zUsc8Fkk4z3MARvLrEBeCKpXSZIZcqQrLhg0wtT8nys=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc2/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0rc2/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
