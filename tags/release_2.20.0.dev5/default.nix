...
#   python -m gen tag 2.20.0.dev5
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev5";
  hash = "sha256-Hj7AzOKAcUP//WbtPJ6tkJLFnslDONL/uL0SxA+2YIQ=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev5/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev5/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
