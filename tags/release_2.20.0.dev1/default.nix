...
#   python -m gen tag 2.20.0.dev1
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev1";
  hash = "sha256-ZAwgSGtW19GJzCoavc/2E6cXVLPregVAW42shdt5ROk=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev1/src/rust/engine/rust-toolchain
  rustVersion = "1.74.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
