...
#   python -m gen tag 2.21.0.dev6
let
  lib = import ../../common/lib.nix;

  version = "2.21.0.dev6";
  hash = "sha256-ANOZE7B1PVGWtkk/XCmRSx1PwNLkN+pAXs06wU4T2e4=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev6/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0.dev6/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
