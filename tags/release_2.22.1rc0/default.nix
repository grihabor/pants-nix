...
#   python -m gen tag 2.22.1rc0
let
  lib = import ../../common/lib.nix;

  version = "2.22.1rc0";
  hash = "sha256-OmBBeU+aNIbZg1kPndUkXtKSL4fKA0YeMuGqsjdBsds=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.1rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.1rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
