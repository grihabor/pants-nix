...
#   python -m gen tag 2.20.0.dev2
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev2";
  hash = "sha256-zPpFBUGyBlDY0R4GafsxeqCod30jW/26mWl09tbGatQ=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev2/src/rust/engine/rust-toolchain
  rustVersion = "1.74.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev2/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
