...
#   python -m gen tag 2.21.0rc0
let
  lib = import ../../common/lib.nix;

  version = "2.21.0rc0";
  hash = "sha256-lC+zlNcXhTX+kWiM5FCim7WOQViGFnCQDTwK39ATuQA=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.77.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.21.0rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
