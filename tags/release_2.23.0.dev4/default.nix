...
#   python -m gen tag 2.23.0.dev4
let
  lib = import ../../common/lib.nix;

  version = "2.23.0.dev4";
  hash = "sha256-juPydZIyHGMD3LrF8zqSdw/LFvq32MAtMnlcSxiB84U=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev4/src/rust/engine/rust-toolchain
  rustVersion = "1.79.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev4/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
