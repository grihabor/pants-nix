...
#   ./gen.py tag 2.19.0rc4
let
  lib = import ../lib.nix;

  version = "2.19.0rc4";
  hash = "sha256-gbw/nWSbHfUHx73Etvsdzddrf7GN4S4lKfBab56mx9A=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc4/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0rc4/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
