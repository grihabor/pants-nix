...
#   python -m gen tag 2.23.0.dev2
let
  lib = import ../../common/lib.nix;

  version = "2.23.0.dev2";
  hash = "sha256-AW0wN4DvdTauInW8f646YmdQgKf+Gq+JwODZCXeNtSA=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev2/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0.dev2/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
