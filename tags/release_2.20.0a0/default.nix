...
#   python -m gen tag 2.20.0a0
let
  lib = import ../../common/lib.nix;

  version = "2.20.0a0";
  hash = "sha256-PFwFSFbyMKYkPwdXgh84e7i48NWXKmKGAFHLEyuS9MM=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0a0/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0a0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
