...
#   python -m gen tag 2.19.2
let
  lib = import ../../common/lib.nix;

  version = "2.19.2";
  hash = "sha256-6QFWoUFT7+kd/qn5lqDds2RAAFyu0Ip945tSwTHacIc=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.2/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.2/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
