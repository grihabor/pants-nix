...
#   python -m gen tag 2.20.0.dev6
let
  lib = import ../../common/lib.nix;

  version = "2.20.0.dev6";
  hash = "sha256-aKL2uaYuQhv2deq86T+BYWYM7M0gdIU5/z9JF3IvUwU=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev6/src/rust/engine/rust-toolchain
  rustVersion = "1.75.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.20.0.dev6/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
