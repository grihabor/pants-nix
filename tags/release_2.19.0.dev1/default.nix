...
#   ./gen.py tag 2.19.0.dev1
let
  lib = import ../lib.nix;

  version = "2.19.0.dev1";
  hash = "sha256-ePFk7epmmFr8I5WGH0botGPi6Hs1kCvPBmywMB5EfIs=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev1/src/rust/engine/rust-toolchain
  rustVersion = "1.72.1";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
