...
#   ./gen.py tag 2.19.0.dev3
let
  lib = import ../lib.nix;

  version = "2.19.0.dev3";
  hash = "sha256-Nbhyz9JBtTttipswGqLeAjir9IIdax1G9ybnUE4URGY=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev3/src/rust/engine/rust-toolchain
  rustVersion = "1.73.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.19.0.dev3/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
